...
var RGBFixture = function(name, interface, outputid)
{
    this.type = "rgb";
    ...
    RGBFixture.prototype.fromJson = function(obj)
    {
        for (var prop in obj) {
    ...
    this.setLevel = function(requestobj, apply){
       ...
       //     white = requestobj.white;
        ...
        // dl/light filter
        // no dl change. for now.
       // var returndataobj = filter_utils.LightLevelFilter(requestobj.requesttype, 100, this.parameters,daylightvolts);
